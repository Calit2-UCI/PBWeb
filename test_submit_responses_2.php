    ...
    <div class="small-10 large-6 small-centered columns">
      ...
      <form method="post" action="app/submit_responses_2.php" name="testform">
        <div class="row">
          ...
          <input id="response_string" type="text" name="response_string" required />
        </div>
        <div class="row">
          <label for="patient_id">Patient ID</label>
          <input id="patient_id" type="number" name="patient_id" required/>
        </div>
        <div class="row">
          <label for="completion_time">Date/Time</label>
          <input id="completion_time" type="datetime" name="completion_time" required value="<?php echo date('Y-m-d H:i:s'); ?>"/>
        </div>
        <div class="row">
