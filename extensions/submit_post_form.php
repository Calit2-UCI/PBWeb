...
$db_connection->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
  ...
  $questions = $_POST['questions'];
	...
	if($_POST['day'] == 1){
	 ...
	 $remove_query = "DELETE FROM chris2.chris_post_day1 WHERE user_id = :pid ";
	 
    $insert_query = "INSERT INTO chris2.chris_post_day1 (USER_ID, submit_time, CPRQ1 ,  CPRQ2 , CPRQ3 , CPRQ4 , CPRQ5 , CPRQ6 ,CPRQ7,
                   CPRQ8  , CPRQ9  , CPRQ10  , CPRQ11  , CPRQ12  , CPRQ13  , CPRQ14  , CPRQ15  , CPRQ16 , CPRQ17  ,
                   CPRQ18 , CPRQ19 , CPRQ20 ,  CPRQ21  , CPRQ22 ,  CPRQ23  , CPRQ24  , CPRQ25,submissionType) VALUES
       (:USER_ID, :submit_time, :CPRQ1, :CPRQ2,:CPRQ3,:CPRQ4,:CPRQ5,:CPRQ6,:CPRQ7 ,
                  :CPRQ8 ,:CPRQ9 ,:CPRQ10 ,:CPRQ11 ,:CPRQ12 ,:CPRQ13 ,:CPRQ14 ,:CPRQ15 ,:CPRQ16,:CPRQ17 ,
                  :CPRQ18,:CPRQ19,:CPRQ20, :CPRQ21 ,:CPRQ22, :CPRQ23 ,:CPRQ24 ,:CPRQ25, 'paper' )";
				  
	}
	else{
		 $remove_query = "DELETE FROM chris2.chris_post_day2 WHERE user_id = :pid ";
		 
		  $insert_query = "INSERT INTO chris2.chris_post_day2 (USER_ID, submit_time, CPRQ1 ,  CPRQ2 , CPRQ3 , CPRQ4 , CPRQ5 , CPRQ6 ,CPRQ7,
                   CPRQ8  , CPRQ9  , CPRQ10  , CPRQ11  , CPRQ12  , CPRQ13  , CPRQ14  , CPRQ15  , CPRQ16 , CPRQ17  ,
                   CPRQ18 , CPRQ19 , CPRQ20 ,  CPRQ21  , CPRQ22 ,  CPRQ23  , CPRQ24  , CPRQ25,submissionType) VALUES
       (:USER_ID, :submit_time, :CPRQ1, :CPRQ2,:CPRQ3,:CPRQ4,:CPRQ5,:CPRQ6,:CPRQ7 ,
                  :CPRQ8 ,:CPRQ9 ,:CPRQ10 ,:CPRQ11 ,:CPRQ12 ,:CPRQ13 ,:CPRQ14 ,:CPRQ15 ,:CPRQ16,:CPRQ17 ,
