    ...
    <div class="small-10 large-6 small-centered columns">
        ...
        <form method="post" action="password_reset.php" name="new_password_form">
          ...
          <div class="row">
            <button type="submit" name="submit_new_password"
                    class="button expand"><?php echo WORDING_SUBMIT_NEW_PASSWORD; ?></button>
          </div>
        </form>
      ...
      <?php } else { ?>
        <form method="post" action="password_reset.php" name="password_reset_form">
          ...
          <div class="row">
            <button type="submit" name="request_password_reset"
                    class="button expand"><?php echo WORDING_RESET_PASSWORD; ?></button>
          </div>
        </form>
      <?php } ?>
